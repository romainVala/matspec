function print_info_ww(fid,filename)
...
for k=1:size(B,1) 
  ...
  sf(1)=      find_ser_descr_watter_width(ff,'MC L','E1E3');
  sf(2)=      find_ser_descr_watter_width(ff,'MC R','E1E3');
  sf(3)=      find_ser_descr_watter_width(ff,'BG L','E1E3');
  sf(4)=      find_ser_descr_watter_width(ff,'BG R','E1E3');

  sf(5)=     find_ser_descr_watter_width(ff,'OCC ref','E1E3E2E4');
  sf(6)=     find_ser_descr_watter_width(ff,'MMref','E1E3E3E4');
  sf(7)=      find_ser_descr_watter_width(ff,'CER','E1E3E2E4');
  
  sf(8)=      find_ser_descr_watter_width(ff,'MC L','E2E4');
  sf(9)=      find_ser_descr_watter_width(ff,'MC R','E2E4');
  sf(10)=      find_ser_descr_watter_width(ff,'BG L','E2E4');
  sf(11)=      find_ser_descr_watter_width(ff,'BG R','E4E4');  

  if sf(6)==0; sf(6) = find_ser_descr_watter_width(ff,'MM ref','E1E3E4E2');end
