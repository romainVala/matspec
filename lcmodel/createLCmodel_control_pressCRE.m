...
switch nb
  ...
  case 2
    basis_set_file_path = '/home/romain/data/spectro/Basis_set/Gosia/Cre/basis_Cr.BASIS';
    basis_set_file_path = '/home/romain/data/spectro/Basis_set/Gosia/Cre/basis_Cr_SS_spec.BASIS';
  case 22
    basis_set_file_path = '/home/romain/data/spectro/Basis_set/Gosia/Cre/basis_Cr_spec.BASIS';
  case 3
    basis_set_file_path = '/home/romain/data/spectro/Basis_set/Gosia/Cre/basis_Cr_SS.BASIS';
  case 4
    basis_set_file_path = '/home/romain/data/spectro/Basis_set/Gosia/Cre/basis_Cr_part.BASIS';
  
  case 5
    basis_set_file_path = '/home/romain/data/spectro/Basis_set/Gosia/PRESS_new7/basis_Cr.BASIS';
  case 6
    basis_set_file_path = '/home/romain/data/spectro/Basis_set/Gosia/PRESS_new7/basis_Cr_spec.BASIS';
  case 7
    basis_set_file_path = '/home/romain/data/spectro/Basis_set/Gosia/PRESS_new7/basis_Cr_part.BASIS';
...
%fprintf(fileid,' LTABLE=7\n');
 ...
 if do_water_scaling
   ...
   switch nb
     case 1
     case {2,6}
       fprintf(fileid,' WSMET=Cr_1\n');
     case 3
     case 4
       fprintf(fileid,' WSMET=CrN\n');
     case 7
...
%fprintf(fileid,' CHUSE1(1)=''ed_GAB'',''ed_NAA'',''ed_Glu'',''ed_Gln'',''Mac''\n');
   switch nb
     ...
     case {2,6}
       fprintf(fileid,' CHUSE1(1)=''Cr_1''\n');
     case 3
        fprintf(fileid,' CHUSE1(1)=''Cr''\n');
     case 4
	fprintf(fileid,' CHUSE1(1)=''CrN''\n');
     case 7
	fprintf(fileid,' CHUSE1(1)=''CrCH3''\n');
